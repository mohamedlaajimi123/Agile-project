...
>
{/* Header */} <div className="text-center space-y-3"> <div className="flex items-center justify-center mb-6"> <img
         src={horizonLogo}
         alt="Horizon School of Digital Technologies"
         className="h-12 w-auto drop-shadow-md"
       /> </div> <h1 className="text-2xl font-bold text-white tracking-tight">
Welcome Back </h1> <p className="text-gray-400 text-sm">
Sign in to your Horizon account </p> </div>
